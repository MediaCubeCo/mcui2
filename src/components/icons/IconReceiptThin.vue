...
<template>
  <McIconShell :view-box="viewBox" v-bind="props">
    <path d="M16 7H8" stroke="currentColor" fill="none"  stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M16.13 11H8" stroke="currentColor" fill="none"  stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <path d="M13 15H8" stroke="currentColor" fill="none"  stroke-linecap="round" stroke-linejoin="round"/>
  </McIconShell>
</template>
