...
<template>
  <McIconShell :view-box="viewBox" v-bind="props">
    <path d="M20.4238 4.80273V7.69573H17.5308H20.4238" stroke="currentColor" fill="none"  stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <path d="M16.5 21C18.9853 21 21 18.9853 21 16.5C21 14.0147 18.9853 12 16.5 12C14.0147 12 12 14.0147 12 16.5C12 18.9853 14.0147 21 16.5 21Z" stroke="currentColor" fill="none"  stroke-linecap="round" stroke-linejoin="round"/>
