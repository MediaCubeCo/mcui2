...
import { computed, defineAsyncComponent, nextTick, onBeforeUnmount, onMounted, type PropType, ref, watch } from 'vue'
...
const McDropdownPanel = defineAsyncComponent(() => import('@/components/patterns/McDropdown/McDropdownPanel.vue'))
...
<style lang="scss" src="./McDropdown.scss"></style>
